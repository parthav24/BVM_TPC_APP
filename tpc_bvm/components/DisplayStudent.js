      ...
      <View style={styles.modalView}>
        ...
        <ScrollView style={styles.scrollViewContent}>
          ...
          >
            <Text style={styles.textView}>
              Sem5: {student?.sem5 === 0 ? "NA" : student?.sem5}
            </Text>
            <Text style={styles.textView}>
              Sem6: {student?.sem6 === 0 ? "NA" : student?.sem6}
            </Text>
            <Text style={styles.textView}>
              Sem7: {student?.sem7 === 0 ? "NA" : student?.sem7}
            </Text>
            <Text style={styles.textView}>
              Sem8: {student?.sem8 === 0 ? "NA" : student?.sem8}
            </Text>
          </View>
          <View
            style={{
          ...
          >
            ...
            <Text style={styles.textView}>
              Deploma:{" "}
              {student?.delopma_cpi === 0 ? "NA" : student?.deploma_cpi}
            </Text>
            <Text style={styles.textView}>
              HSC:{" "}
              {student?.hsc_percentage === 0 ? "NA" : student?.hsc_percentage}
            </Text>
          ...
          <Text style={styles.modalText}>
            No. of Active Backlogs: {student?.no_active_backlog}
          </Text>
          <Text style={styles.modalText}>
            No. of Dead Backlogs: {student?.no_dead_backlog}
          </Text>
          <View style={styles.line} />
        </ScrollView>
        {selectedTab === "pending" && (
        ...
        <Button
          ...
          onPress={() => {
            ...
            navigation.navigate("EditStudentDetails"); // Now navigation should work
          }}
        />
      </View>
    </Modal>
